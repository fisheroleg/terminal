    ...
    <body>
        <div class="middle">
            <div id="container">
                <form id="f" class="current">
                    ...
                    <div class="form-group has-success has-feedback">
                        <div class="input-group">
                            ...
                            <span class="input-group-addon" id="submitForm"><i class="fa fa-chevron-right"></i></span>
                        </div>
                ...
                <span class="pull-right link" href="/signup">Sign up</span>
            </div>
